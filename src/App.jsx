    ...
    <React.Fragment>
      ...
      <Drawer open={open} onClose={() => setOpen(false)}>
        ...
        >
          ...
          <ListItemButton sx={{ fontWeight: 'lg' }} >Toutes les catégories</ListItemButton>
          ...
          <ListItemButton sx={{ color : '#00C3E3'}}>Qui sommes-nous </ListItemButton>
          <ListItemButton sx={{ color : '#00C3E3'}}>Mode d&rsquo;emploi</ListItemButton> 
        </List>
      </Drawer>
    </React.Fragment>
  );
